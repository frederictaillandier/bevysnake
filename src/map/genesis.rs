...
pub const SEED_WORD: &str = "janicka";
...
const HEIGHT_AMPLITUDE: f64 = 6.0;
/// Base terrain height in voxels.
const HEIGHT_BASE: f64 = 8.0;
...
pub fn generate_chunk(chunk_origin: [i32; 3]) -> Chunk {
    ...
    for z in 0..CHUNK_SIZE {
        for x in 0..CHUNK_SIZE {
            ...
            let surface_y = (HEIGHT_BASE + raw * HEIGHT_AMPLITUDE).round() as i32;
